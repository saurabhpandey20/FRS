...
#first
        img=Image.open(r"C:\Users\Saurabh pandey\Downloads\college-images\college_images\face-recognition.png")
 ...
 #second
        img1=Image.open(r"C:\Users\Saurabh pandey\Downloads\college-images\college_images\smart-attendance.jpg")
 ...
 #third
        img2=Image.open(r"C:\Users\Saurabh pandey\Downloads\college-images\college_images\gettyimages-1022573162.jpg")
...
# bg image
    ...
    #left label frame
        ...
        img_left=Image.open(r"C:\Users\Saurabh pandey\Downloads\college-images\college_images\gettyimages-1022573162.jpg")
...
#right label frame
        ...
        img_right=Image.open(r"C:\Users\Saurabh pandey\Downloads\college-images\college_images\face-recognition.png")
        img_right=img2.resize((700,130),Image.LANCZOS)
  ...
  # Table      
        ...
        self.student_table.heading("photo",text="PhotoSampleStatust")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="" :
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Srbh@9668",database="face_recognizer")
                my_cursor=conn.cursor()
                my_cursor.execute("insert into student valuse(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Stident details has been added Successfully",parent=self.root)          
    ...
    def fetch_data(self):
        ...
        if len(data)!=0:
                ...
                for i in data:
                    ...
                    self.student_table.insert("",END,valuse=i)
                conn.comit()
                conn.close()        
